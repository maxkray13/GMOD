...
public:
	...
	virtual bool SetFontGlyphSet_Extended(HFont font, const char *windowsFontName, int tall, int weight, int blur, int scanlines, int flags, int nRangeMin = 0, int nRangeMax = 0) = 0;
	...
	virtual void GMOD_GetTextSize() = 0;
	...
	virtual int DrawColoredText(HFont font, int x, int y, int r, int g, int b, int a, PRINTF_FORMAT_STRING const char *fmt, ...) = 0;
	...
	virtual void DrawTextHeight(HFont font, int w, int& h, PRINTF_FORMAT_STRING const char *fmt, ...) = 0;
